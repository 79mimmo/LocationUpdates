...
public class MainActivity extends FragmentActivity implements
    ...
    private TextView mAccuracyStatus;
    private TextView mAccuracyState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccuracyState = (TextView) findViewById(R.id.text_accuracy_state);
        mAccuracyStatus = (TextView) findViewById(R.id.text_accuracy_status);
        mProvider = (TextView) findViewById(R.id.provider);
        mProviderLabel= (TextView) findViewById(R.id.label_provider);
        mExtraInfo= (TextView) findViewById(R.id.finestra_info);
         ...
         */
        mLocationRequest.setInterval(com.example.android.locationupdates.LocationUtils.UPDATE_INTERVAL_IN_MILLISECONDS);
    ...
    public void getLocation(View v) {
        ...
        if (servicesConnected()) {
            ...
            //prova
            Float direzione=currentLocation.getBearing();
            float velocità=currentLocation.getSpeed();
            double altezza=currentLocation.getAltitude();
            //Estraggo le info extra dal bundle
            Bundle bundleExtra=currentLocation.getExtras();
            if (bundleExtra!=null) {
                Set<String> bundleSet = bundleExtra.keySet();
                Iterator<String> iterBundle = bundleSet.iterator();
                mExtraInfo.setText(R.string.extra_info);
                while (iterBundle.hasNext()) {
                    String chiave = iterBundle.next();
                    mExtraInfo.setText(mExtraInfo.getText() + "\n" + chiave);
                }
            }
            // Display the current location in the UI
            mLatLng.setText(LocationUtils.getLatLng(this, currentLocation));
            mAccuracyState.setText(LocationUtils.getAccuracy(this, currentLocation));
            mProvider.setText(LocationUtils.getProvider(this,currentLocation));
